...
\$(NAME): %s
	rm -f \$@ \$@.tmp
	\$(CC) -L ../../submodules/core -l mb_core -L ../../submodules/real_float -l mb_real_float -o \$@.tmp \$^
	mv \$@.tmp \$@

CPPFLAGS = -I ../../submodules/core/include -I ../../submodules/real_float/include -D NDEBUG
